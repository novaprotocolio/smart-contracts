...
contract LibOrder is EIP712, LibSignature, LibMath {
    ...
    /**
     * Calculates the Keccak-256 EIP712 hash of the order using the Nova Protocol domain.
     *
     * @param order The order data struct.
     * @return Fully qualified EIP712 hash of the order in the Nova Protocol domain.
     */
