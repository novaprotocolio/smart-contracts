 ...
 *
 * First, Relayers can opt into or out of the Nova liquidity incentive system.
 *
...
contract LibRelayer {
    ...
    /**
     * Join the Nova incentive system.
     */
    ...
    /**
     * Exit the Nova incentive system.
     * For relayers that choose to opt-out, the Nova Protocol
    ...
    /**
     * @return true if relayer is participating in the Nova incentive system.
     */
